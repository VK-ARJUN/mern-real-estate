  ...
  return (
    <div className='p-3 max-w-lg mx-auto '>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input type='text' placeholder='Username' className='border border-gray-300 rounded-lg p-3 ' id='username' onChange={handleChange}/>
        ...
        <button disabled={loading} type='submit' className='bg-blue-500 text-white rounded-lg p-3 hover:opacity-95 disabled:opacity-80'>{loading ? 'Loading...' : 'Sign Up'}</button>
      </form>
